...
the TPA-style working/thinking distinction (branch 4) instead of falling
through the flat non-TPA OR-fallback.
"""
...
def test_codex_detector_absent_matches_pure_tpa_behavior(monkeypatch):
    install_world(monkeypatch)

"""Tests for TPADetector -- ports the legacy watcher behaviors
...
def test_cpu_busy_requires_sustained_streak():
    ...
    spikes from flipping Squid into thinking when TPA is actually idle)."""

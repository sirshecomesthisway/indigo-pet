...
class StateMachine:
    ...
    def compute(self) -> PetState:
        ...
        # multiple TPA consoles open, aggregate agent_idle_seconds stays 0 as
        # long as ANY TPA is working -- which masks the one that's actually
